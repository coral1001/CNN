# -*- coding: utf-8 -*-
"""
Created on Thu Apr  1 09:08:40 2021
...
'''
transform = transforms.Compose([transforms.ToTensor(), transforms.RandomCrop(32,padding=4), transforms.Normalize((0.1307,), (0.3081,))])

#加载训练集，pytorch十分贴心的为我们直接准备了这个数据集，注意，即使你没有下载这个数据集
#在函数中输入download=True，他在运行到这里的时候发现你给的路径没有，就自动下载
train_dataset = datasets.MNIST(root='../test/', 
                               train=True, 
                               download=True, 
                               transform=transform)
